...
class CommandMixin:
    ...
    # 同步相关命令
    @meme_manager_master.command("同步状态")
    ...
    @filter.permission_type(filter.PermissionType.ADMIN)
    @meme_manager_master.command("同步到云端")
    ...
    @filter.permission_type(filter.PermissionType.ADMIN)
    @meme_manager_master.command("从云端同步")
    ...
    @filter.permission_type(filter.PermissionType.ADMIN)
    @meme_manager_master.command("覆盖到云端")
    ...
    @filter.permission_type(filter.PermissionType.ADMIN)
    @meme_manager_master.command("从云端覆盖")
